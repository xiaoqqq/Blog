 ...
 * packageName：cn.wonhigh.belleexam.view.
 * projectName: BelleExam.
 * email: xiao.qing@wonhigh.cn
 * desc: 带可清除的editText
 */
public class ClearableEditText extends AutoCompleteTextView implements View.OnTouchListener, View.OnFocusChangeListener, TextWatcher {
    ...
    private void init() {
        ...
        if (_right == null) {
            _right = getResources().getDrawable(R.mipmap.clean);
        }
